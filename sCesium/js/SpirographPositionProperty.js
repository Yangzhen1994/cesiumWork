...
(function (Cesium) {
     ...
     * @constructor
     *
     * @param {Cesium.Cartographic} center The center of the spirograph 运动中心
     * @param {Number} radiusMedian The radius of the median circle 中间圆半径
     * @param {Number} radiusSubCircle 中间圆的最大距离
     * @param {Number} durationMedianCircle 时间以毫秒为单位圆轨道中间
     * @param {Number} durationSubCircle 时间以毫秒为单位子圆轨道
     * @param {Cesium.Ellipsoid} [ellipsoid=Cesium.Ellipsoid.WGS84] 将地图转换成笛卡尔的椭球体
     */
